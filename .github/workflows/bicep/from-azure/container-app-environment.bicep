...
param container_app_environment_name string = 'caenv-dev-tag-private'

resource private_container_app_environment 'Microsoft.App/managedEnvironments@2025-10-02-preview' existing = {
...
resource container_app 'Microsoft.App/containerApps@2026-01-01' = {
  ...
  properties: {
    environmentId: private_container_app_environment.id
